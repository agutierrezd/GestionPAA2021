...
function fillProjectEntites()
{
	...
	$projectEntities[ "tparam_fuenterec" ] = array( "url" => "tparam_fuenterec", "type" => 0 );
	$projectEntitiesReverse[ "tparam_fuenterec" ] = "tparam_fuenterec";
	$projectEntities[ "003_actividad" ] = array( "url" => "003_actividad", "type" => 0 );
	$projectEntitiesReverse[ "003_actividad" ] = "003_actividad";
	$projectEntities[ "q_reporte_000_sector" ] = array( "url" => "q_reporte_000_sector", "type" => 3 );
	$projectEntitiesReverse[ "q_reporte_000_sector" ] = "q_reporte_000_sector";
	$projectEntities[ "tparam_uej" ] = array( "url" => "tparam_uej", "type" => 0 );
	$projectEntitiesReverse[ "tparam_uej" ] = "tparam_uej";
	$projectEntities[ "q_reporte_001_sector" ] = array( "url" => "q_reporte_001_sector", "type" => 3 );
	$projectEntitiesReverse[ "q_reporte_001_sector" ] = "q_reporte_001_sector";
	$projectEntities[ "q_reporte_002_sector" ] = array( "url" => "q_reporte_002_sector", "type" => 3 );
	$projectEntitiesReverse[ "q_reporte_002_sector" ] = "q_reporte_002_sector";
	$projectEntities[ "q_reporte_002" ] = array( "url" => "q_reporte_002", "type" => 0 );
	$projectEntitiesReverse[ "q_reporte_002" ] = "q_reporte_002";
	$projectEntities[ "000_global" ] = array( "url" => "000_global", "type" => 0 );
	$projectEntitiesReverse[ "000_global" ] = "000_global";
	$projectEntities[ "001_rubro_f" ] = array( "url" => "001_rubro_f", "type" => 1 );
	$projectEntitiesReverse[ "001_rubro_f" ] = "001_rubro_f";
	$projectEntities[ "000_global_f" ] = array( "url" => "000_global_f", "type" => 1 );
	$projectEntitiesReverse[ "000_global_f" ] = "000_global_f";
	$projectEntities[ "002_producto_f" ] = array( "url" => "002_producto_f", "type" => 1 );
	$projectEntitiesReverse[ "002_producto_f" ] = "002_producto_f";
	...
	$projectEntities[ "q_ctrl_saldos_act_paa" ] = array( "url" => "q_ctrl_saldos_act_paa", "type" => 0 );
	$projectEntitiesReverse[ "q_ctrl_saldos_act_paa" ] = "q_ctrl_saldos_act_paa";
	$projectEntities[ "paa_master_f" ] = array( "url" => "paa_master_f", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_f" ] = "paa_master_f";
	$projectEntities[ "q_recursos_gestor_f1" ] = array( "url" => "q_recursos_gestor_f1", "type" => 0 );
	$projectEntitiesReverse[ "q_recursos_gestor_f1" ] = "q_recursos_gestor_f1";
	$projectEntities[ "q_ctrl_saldos_prod_paa" ] = array( "url" => "q_ctrl_saldos_prod_paa", "type" => 0 );
	$projectEntitiesReverse[ "q_ctrl_saldos_prod_paa" ] = "q_ctrl_saldos_prod_paa";
}
