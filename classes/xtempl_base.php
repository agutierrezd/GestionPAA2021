...
class XTempl_Base
{
	 ...
	 function __construct( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("q_reporte_000_sector_chart","xt_showchart",
			array(
				"chartName"=>"q_reporte_000_sector",
				"table"=>"q_reporte_000_sector",
				"ctype"=>"2DColumn"));
			$this->assign_function("q_reporte_001_sector_chart","xt_showchart",
			array(
				"chartName"=>"q_reporte_001_sector",
				"table"=>"q_reporte_001_sector",
				"ctype"=>"2DBar"));
			$this->assign_function("q_reporte_002_sector_chart","xt_showchart",
			array(
				"chartName"=>"q_reporte_002_sector",
				"table"=>"q_reporte_002_sector",
				"ctype"=>"2DColumn"));
		}
