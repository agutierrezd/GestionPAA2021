...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("rep_prg001_catalogopresupuestal" == $this->chrt_array['tables'][0])
			return true;
		if("001_rubro" == $this->chrt_array['tables'][0])
			return true;
		...
		if("tparam_fuente" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_fuenterec" == $this->chrt_array['tables'][0])
			return true;
		if("003_actividad" == $this->chrt_array['tables'][0])
			return true;
		if("q_reporte_000" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_uej" == $this->chrt_array['tables'][0])
			return true;
		if("q_reporte_001" == $this->chrt_array['tables'][0])
			return true;
		if("q_reporte_002" == $this->chrt_array['tables'][0])
			return true;
		if("q_reporte_002" == $this->chrt_array['tables'][0])
			return true;
		if("000_global" == $this->chrt_array['tables'][0])
			return true;
		if("001_rubro" == $this->chrt_array['tables'][0])
			return true;
		if("000_global" == $this->chrt_array['tables'][0])
		...
		if("dependencia" == $this->chrt_array['tables'][0])
			return true;
		if("q_recursos_gestor_c" == $this->chrt_array['tables'][0])
			return true;
		if("q_recursos_gestor_c1" == $this->chrt_array['tables'][0])
			return true;
		...
		if("global_estado" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_saldos_act_paa" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("q_recursos_gestor_f1" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_saldos_prod_paa" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
