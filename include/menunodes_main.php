...
function getMenuNodes_main($menuNodesObject)
{
	...
	$menuNode["href"] = "mypage.htm";
	$menuNode["type"] = "Leaf";
	$menuNode["table"] = "global_ubicacion";
	$menuNode["style"] = "";
	$menuNode["params"] = "";
	$menuNode["parent"] = "0";
	$menuNode["nameType"] = "Text";
	...
	$menuNode["title"] = "Global Ubicacion";
