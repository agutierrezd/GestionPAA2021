...
function checkTableName($shortTName, $type=false)
{
	...
	if ("secop" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ep_agregada" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("rep_prg001_catalogopresupuestal" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("001_rubro" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("002_producto" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("tparam_fuente" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tparam_fuenterec" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("003_actividad" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("q_reporte_000_sector" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	if ("tparam_uej" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("q_reporte_001_sector" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	if ("q_reporte_002_sector" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	if ("q_reporte_002" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("000_global" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("001_rubro_f" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("000_global_f" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("002_producto_f" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("dependencia" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("q_recursos_gestor_c" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("q_recursos_gestor_c1" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("global_estado" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("q_ctrl_saldos_act_paa" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("paa_master_f" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("q_recursos_gestor_f1" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("q_ctrl_saldos_prod_paa" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("001_rubro");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_fuenterec");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_fuenterec";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("003_actividad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_reporte_000_sector");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_reporte_000_sector";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_reporte_001_sector");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_reporte_001_sector";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_reporte_002_sector");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_reporte_002_sector";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_reporte_002");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("000_global");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("001_rubro_f");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("000_global_f");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("002_producto_f");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_recursos_gestor_c");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_recursos_gestor_c";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_recursos_gestor_c1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_recursos_gestor_c1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_saldos_act_paa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_saldos_act_paa";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_f");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_recursos_gestor_f1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_recursos_gestor_f1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_saldos_prod_paa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_saldos_prod_paa";
	}
	return $arr;
}
...
{
	if($shorttable=="q_reporte_000_sector")
		return "2DColumn";
	if($shorttable=="q_reporte_001_sector")
		return "2DBar";
	if($shorttable=="q_reporte_002_sector")
		return "2DColumn";
	return "";
}
...
//	default permissions
	...
	if( $table=="q_reporte_001_sector" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_reporte_002_sector" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_reporte_002" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="001_rubro_f" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="000_global_f" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="002_producto_f" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="q_recursos_gestor_c" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_recursos_gestor_c1" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="q_ctrl_saldos_act_paa" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_f" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_recursos_gestor_f1" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_ctrl_saldos_prod_paa" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
...
function SetAuthSessionData($pUsername, &$data, $password, &$pageObject = null, $fireEvents = true )
{
	...
	$_SESSION["_q_recursos_gestor_c_OwnerID"] = $data["Username"];
		$_SESSION["_q_recursos_gestor_c1_OwnerID"] = $data["idusrglobal"];
