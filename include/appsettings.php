...
$globalSettings["strSMTPServer"] = "127.0.0.1";
...
<IMG height=\"100%\" id=\"navbarlogo\" alt=\"Logo Entidad\" src=\"images/xlogo_300x59.png\" />
</DIV>";
...
$projectBuildKey = "483_1605070049";
$wizardBuildKey = "34656";
$projectBuildNumber = "483";
...
$tableCaptions["Spanish"]["001_rubro"] = "RUBRO INVERSIÓN";
$tableCaptions["Spanish"]["002_producto"] = "PRODUCTO INVERSIÓN";
...
$tableCaptions["Spanish"]["tparam_fuenterec"] = "Tparam Fuenterec";
$tableCaptions["Spanish"]["003_actividad"] = "Actividad";
$tableCaptions["Spanish"]["q_reporte_000_sector"] = "Q Reporte 000 Sector";
$tableCaptions["Spanish"]["tparam_uej"] = "Tparam Uej";
$tableCaptions["Spanish"]["q_reporte_001_sector"] = "Resumen sector";
$tableCaptions["Spanish"]["q_reporte_002_sector"] = "Resumen sector | Tipo";
$tableCaptions["Spanish"]["q_reporte_002"] = "Detalle";
$tableCaptions["Spanish"]["000_global"] = "INVERSIÓN";
$tableCaptions["Spanish"]["001_rubro_f"] = "RUBRO FUNCIONAMIENTO";
$tableCaptions["Spanish"]["000_global_f"] = "FUNCIONAMIENTO";
$tableCaptions["Spanish"]["002_producto_f"] = "PRODUCTO FUNCIONAMIENTO";
$tableCaptions["Spanish"]["dependencia"] = "Dependencia";
$tableCaptions["Spanish"]["q_recursos_gestor_c"] = "Q Recursos Gestor C";
$tableCaptions["Spanish"]["q_recursos_gestor_c1"] = "Q Recursos Gestor C1";
...
$tableCaptions["Spanish"]["q_ctrl_saldos_act_paa"] = "Q Ctrl Saldos Act Paa";
$tableCaptions["Spanish"]["paa_master_f"] = "Paa Master F";
$tableCaptions["Spanish"]["q_recursos_gestor_f1"] = "Q Recursos Gestor F1";
$tableCaptions["Spanish"]["q_ctrl_saldos_prod_paa"] = "Q Ctrl Saldos Prod Paa";
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$page_titles[".global"]["Spanish"]["login"] = "Planeación y Gestión";
}
...
//if ( $_REQUEST['mastertable'] == '002_producto') {
// Consultamos si el registro Master está ACTIVO
//$key1 = $_REQUEST['masterkey1'];
//$sql="SELECT sep2.002_producto.SALDO prodsaldo FROM sep2.002_producto WHERE sep2.002_producto.PROD_ID = $key1";
//$rs=db_query($sql,$conn);
//$data=db_fetch_array($rs);
//if ($data['prodsaldo'] <= 0) { // Consulta si "persona está de baja
//		$_SESSION['actividad_add'] = false; // No puede haber Add y DELETE
//		} else {
//		$_SESSION['actividad_add'] = true;  // Sí puede haber Add y DELETE
//	}
//}
