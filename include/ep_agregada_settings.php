...
$tdataep_agregada[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdataep_agregada[".originalPagesByType"] = $tdataep_agregada[".pagesByType"];
$tdataep_agregada[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdataep_agregada[".originalPages"] = $tdataep_agregada[".pages"];
$tdataep_agregada[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
$tdataep_agregada[".popupPagesLayoutNames"] = $popupPagesLayoutNames;
...
$tdataep_agregada[".listAjax"] = false;
	...
	$tdataep_agregada[".audit"] = true;

	$tdataep_agregada[".locking"] = true;
...
$tdataep_agregada[".addPageEvents"] = false;

// use timepicker for search panel
$tdataep_agregada[".isUseTimeForSearch"] = false;


$tdataep_agregada[".badgeColor"] = "008B8B";
...
$tdataep_agregada[".isDisplayLoading"] = true;
...
$tableEvents["ep_agregada"] = new eventsBase;
$tdataep_agregada[".hasEvents"] = false;
