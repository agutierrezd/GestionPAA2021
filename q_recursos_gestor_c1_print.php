...
require_once("include/q_recursos_gestor_c1_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "q_recursos_gestor_c1" );
