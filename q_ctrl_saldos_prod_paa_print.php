...
require_once("include/q_ctrl_saldos_prod_paa_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "q_ctrl_saldos_prod_paa" );
